...
FastAPI + Strawberry GraphQL service for user management.
...
# FastAPI app
app = FastAPI(
    title="User Service GraphQL",
    description="User management service - GraphQL Subgraph with Apollo Federation",
    version="1.0.0",
...
async def startup_event():
    ...
    logger.info(f"🎨 GraphiQL UI: http://{settings.host}:{settings.port}/graphql")
